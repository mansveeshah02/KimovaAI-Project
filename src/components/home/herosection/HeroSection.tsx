...
export default function TurboAuditSection() {
  return (
    <section
      ...
      pt-[100px]" // header ke niche gap ke liye extra top padding
    >
      {/* Background Image with Stronger Zoom on Hover */}
      <div className="absolute inset-0 -z-50 transition-transform duration-1000 group-hover:scale-150">
        <Image
      ...
      <div className="max-w-4xl mx-auto space-y-6 relative z-10">
        ...
        <p className="text-sm sm:text-md sm:text-lg leading-relaxed text-white/90 px-2 sm:px-0">
          ...
          <strong className="text-white">end-to-end auditor workflows</strong>, analyzes uploaded documents with
          unparalleled depth to identify gaps, and delivers actionable insights, transforming audits from a burden into
